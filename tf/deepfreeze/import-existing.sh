...
# Import existing Elasticsearch VMs into new Terraform state

set -e

echo "🔄 Importing existing Elasticsearch VMs..."
...
for i in "${!VMS[@]}"; do
    ...
    terraform import "module.elasticsearch_vms[$i].proxmox_vm_qemu.vm" "$import_id"
